...
- [ ] Commit Message: `feat(v2.0): Implement Caller Monopoly with openseal run and Disclosure Policy`
- [ ] Tag: `v2.0-rc1` (Release Candidate 1)
...
## 4. 검토 요청 (Review Request)
위 계획대로 **저장소 정리 ➡️ 문서 분류(docs/public vs internal) ➡️ 커밋 ➡️ 태깅**을 진행해도 되겠습니까?
승인하시면 즉시 실행하겠습니다.
